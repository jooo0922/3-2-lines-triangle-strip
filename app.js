...
function startup() {
  ...
  gl.frontFace(gl.CW); // 반시계 방향 삼각형 -> 시계 방향 삼각형으로 관찰자에게 향하는 삼각형들을 변경함.
  // -> 반시계 방향으로 그려진 삼각형들은 지워지고, 두 번째 스트립 삼각형들만 살아남음. -> 여분 인덱스를 줄여버렸더니 두 번째 스트립의 삼각형들이 그려지는 방향이 CCW -> CW로 바뀌었나봄. 그러니까 얘내만 살아남지!
